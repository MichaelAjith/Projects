...
if(!isset($_SESSION['stdname'])) {
    $_GLOBALS['message']="Session Timeout.Click here to <a href=\"indexs.php\">Re-LogIn</a>";
}
...
<html>
  <head>
    <title>SAD-Test Conducter</title>
  ...
  <body >
      ...
      <div class="header">
          ...
          <div class="menubar" style="text-align:center;">
              <h2 style="font-family:helvetica,sans-serif;font-weight:bolder;font-size:120%;color:#f50000;padding-top:0.3em;letter-spacing:1px;">SAD:Test Conducter</h2>
          </div>
      <div class="page">
          <?php
